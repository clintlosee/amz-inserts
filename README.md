...
- **Custom** — one-off text, image, card, or grid in this post without saving a unit. Paste an Amazon URL and optionally click **Fetch from URL** for a best-effort title and image (same lookup as saved units; Amazon often blocks it).
